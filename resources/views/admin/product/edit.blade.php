                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="role" value="{{ $product->name }}" placeholder="Enter product name" name="name" />
                                            @error('name')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="price" value="{{ $product->price }}" placeholder="Enter department name" name="price" />
                                            @error('price')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="icon" class="form-label">Product image old</label><br>
                                            <img src="{{ asset($product->image) }}" alt="" width="120px" height="120px">
                                        </div>
