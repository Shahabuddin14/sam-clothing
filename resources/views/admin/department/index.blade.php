...
@section('department-list') active @endsection
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach ($departments as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->name }}</td>
                                            <td>
                                                @isset(auth()->user()->role->permission['permission']['department.edit']['edit'])
                                                    <a class="btn btn-md bg-warning" href="{{ url('admin/department-edit/'.$item->id) }}">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                @endisset

                                                @isset(auth()->user()->role->permission['permission']['department.delete']['delete'])
                                                    <a class="btn btn-md bg-danger" href="{{ url('admin/department-delete/'.$item->id) }}">
                    ...
                    @isset(auth()->user()->role->permission['permission']['department.store']['create'])
                        <div class="col-5">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Department item</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
